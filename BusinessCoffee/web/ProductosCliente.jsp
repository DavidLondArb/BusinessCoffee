...
<html>
    ...
    <body>
        ...
        <ul class="Menu">
            ...
            <li id="men"><a href="PerfilCliente.jsp" name="PerfilC"><%= nombre%></a></li>                                <!MODIFICACION>
        </ul>
        <br>
        <div class="contenedor">
            ...
            %>
                    <div class="col s12 m6 l6">
                        <%
                        OperacionesFav opFav= new OperacionesFav(infoCl.getCodigoClient(),c.getCodigoproducto());
                        opFav.listarFavoritos();
                        %>
                        <div class="material-placeholder"><a class="agregFav" id="agregarFavorito<%=c.getCodigoproducto()%>" href=""><i id="icon<%=c.getCodigoproducto()%>" class="material-icons n1" onclick="icono(<%=c.getCodigoproducto()%>,<%=infoCl.getCodigoClient()%>);"><%=opFav.getIcono()%></i></a><a href="Login?pagina=MostrPCliente&codigoP=<%=c.getCodigoproducto()%>">
