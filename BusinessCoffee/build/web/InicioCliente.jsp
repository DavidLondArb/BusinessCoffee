<%-- 
    ...
    Created on : 26/05/2020, 05:19:24 PM
    Author     : mvarv
--%>
...
<html>
    ...
    <body>
        ...
        <ul class="Menu">
            ...
            <li id="men"><a href="Login?pagina=ListarProductoC" name="Prod">Productos</a></li>
            <li id="men"><a href="ElCafeCliente.jsp">El caf&eacute;</a></li>
            <li id="men"><a href="BeneficiosCliente.jsp">Beneficios</a></li>
            <li id="men"><a href="PerfilCliente.jsp" name="PerfilC"><%= nombre%></a></li>
        </ul>
        <br>
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l6">
                        <div class="material-placeholder">
                            <img src="imgProductos/Cafe.png" class="responsive-img materialboxed">
